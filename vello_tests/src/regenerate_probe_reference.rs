...
mod tests {
    ...
    fn probe_reference_is_up_to_date() {
        ...
        assert_eq!(
            ...
            "probe.rgba is out of date; run `cargo run -p vello_tests --features reference-generation --bin regenerate_probe_reference`",
        );
        assert_eq!(
            committed_png, reference.png,
            "probe.png is out of date; run `cargo run -p vello_tests --features reference-generation --bin regenerate_probe_reference`",
        );
    }
}
